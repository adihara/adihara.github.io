...
<i class="fab fa-r-project"></i> `R` <br> <i class="fab fa-python"></i>`Python` <br> <i class="fab fa-markdown"></i> `RMarkdown / Quarto` <br> <i class="fas fa-code-branch"></i> `Git` <br> <i class="fab fa-github"></i> `GitHub` <br> <i class="fa-solid fa-database"></i> `REDCap` <br>
:::
