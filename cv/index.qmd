...
cv_url <- "https://docs.google.com/spreadsheets/d/1hkhU0OKpuzpw_fuJlDI8g2g-xuOTb8_r4XybPk5rhmE/edit?usp=sharing"
...
Resume made with 🩵 and [Quarto](https://quarto.org/). Last updated on `r format.Date(Sys.Date(), "%b %d, %Y")`. <br> Code available on <i class="fa-brands fa-github"></i> [GitHub](https://github.com/adihara). <br>License: [CC BY-SA 2.0](https://creativecommons.org/licenses/by-sa/2.0/).
